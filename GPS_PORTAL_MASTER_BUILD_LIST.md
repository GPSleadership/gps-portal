...
| **P2-UX6** | **Shared style-token system (CSS variables)** to replace the scattered inline hex/spacing — prerequisite for a consistent premium visual pass. | M | ⏳ queued | coach.html inline styles throughout |
